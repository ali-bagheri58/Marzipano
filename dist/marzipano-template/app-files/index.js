...
(function() {
  ...
  function createLinkHotspotElement(hotspot) {
    ...
    wrapper.style.width = hotspotSize + 'px';
    wrapper.style.height = hotspotSize + 'px';
    wrapper.style.marginLeft = (-hotspotSize / 2) + 'px';
    wrapper.style.marginTop = (-hotspotSize / 2) + 'px';
